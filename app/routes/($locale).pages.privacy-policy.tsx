    ...
    <div className="bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 md:px-8 lg:px-12 py-16 md:py-24">
        ...
        <div className="space-y-6 md:space-y-8 font-sans text-sm md:text-base leading-relaxed text-foreground">
          ...
          <p>
            adina.household operates this store and website, including all related information,
            content, features, tools, products and services, in order to provide you, the customer,
            with a curated shopping experience (the &ldquo;Services&rdquo;). adina.household is
            powered by Shopify, which enables us to provide the Services to you. This Privacy Policy
            describes how we collect, use, and disclose your personal information when you visit,
            use, or make a purchase or other transaction using the Services or otherwise communicate
            with us. If there is a conflict between our Terms of Service and this Privacy Policy,
            this Privacy Policy controls with respect to the collection, processing, and disclosure
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Contact details including your name, address, billing address, shipping address, phone
              number, and email address.
            </li>
            <li>
              Financial information including credit card, debit card, and financial account
              numbers, payment card information, financial account information, transaction details,
              form of payment, payment confirmation and other payment details.
            </li>
            <li>
              Account information including your username, password, security questions, preferences
              and settings.
            </li>
            <li>
              Transaction information including the items you view, put in your cart, add to your
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Directly from you including when you create an account, visit or use the Services,
            ...
            <li>
              ...
              products or services or visit our websites, and through the use of cookies and similar
              technologies;
            </li>
            <li>
              From our service providers including when we engage them to enable certain technology
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1">
                We use your personal information to provide you with the Services, including to
                perform our contract with you, to process your payments, to fulfill your orders, to
                remember your preferences and items you are interested in, to send notifications to
                you related to your account, to process purchases, returns, exchanges or other
                transactions, to create, maintain and otherwise manage your account, to arrange for
                shipping, to facilitate any returns and exchanges, to enable you to post reviews,
                and to create a customized shopping experience for you, such as recommending
                products related to your purchases. This may include using your personal information
                to better tailor and improve the Services.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-foreground">Marketing and Advertising.</h3>
              <p className="mt-1">
                We use your personal information for marketing and promotional purposes, such as to
                send marketing, advertising and promotional communications by email, text message or
                postal mail, and to show you online advertisements for products or services on the
                Services or other websites, including based on items you previously have purchased
                or added to your cart and other activity on the Services.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-foreground">Security and Fraud Prevention.</h3>
              <p className="mt-1">
                We use your personal information to authenticate your account, to provide a secure
                ...
                and to secure our services. If you choose to use the Services and register an
                account, you are responsible for keeping your account credentials safe. We highly
                recommend that you do not share your username, password or other access details with
                anyone else.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-foreground">Communicating with You.</h3>
              <p className="mt-1">
                We use your personal information to provide you with customer support, to be
                responsive to you, to provide effective services to you and to maintain our business
                relationship with you.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-foreground">Legal Reasons.</h3>
              <p className="mt-1">
                We use your personal information to comply with applicable law or respond to valid
                legal process, including requests from law enforcement or government agencies, to
                investigate or participate in civil discovery, potential or actual litigation, or
                other adversarial legal proceedings, and to enforce or investigate potential
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              With business and marketing partners to provide marketing services and advertise to
              you. For example, we use Shopify to support personalized advertising with third-party
              services based on your online activity with different merchants and websites. Our
              business and marketing partners will use your information in accordance with their own
              privacy notices. Depending on where you reside, you may have a right to direct us not
              to share information about you to show you targeted advertisements and marketing based
            ...
            <li>
              ...
              warrants and similar requests), to enforce any applicable terms of service or
              policies, and to protect or defend the Services, our rights, and the rights of our
              users or others.
            </li>
          </ul>
          ...
          <p>
            ...
            you may have, you can visit the{' '}
            <a
              href="https://www.shopify.com/legal/privacy/consumer-privacy"
              target="_blank"
            ...
            . Depending on where you reside, you may exercise certain rights with respect to your
          ...
          <p>
            ...
            knowledge that we &ldquo;share&rdquo; or &ldquo;sell&rdquo; (as those terms are defined
          ...
          <p>
            ...
            may not be secure while in transit. We recommend that you do not use unsecure channels
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              emails, and you may opt out of receiving these at any time by using the unsubscribe
          ...
          <p>
            ...
            processed by Shopify, you can visit{' '}
            <a
              href="https://privacy.shopify.com/en"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p>
            ...
            right to appeal our decision by contacting us using the contact details set out below,
          ...
          <p>
            ...
            or contact us at Al-Raheem Tower, Karachi, 7400, PK.
          </p>
        </div>
      </div>
    </div>
