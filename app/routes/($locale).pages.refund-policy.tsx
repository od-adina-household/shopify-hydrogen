      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 lg:px-12 py-16 md:py-24">
        ...
        <div className="space-y-6 md:space-y-8 font-sans text-sm md:text-base leading-relaxed text-foreground">
          ...
          <p>
            ...
            . Please note that returns will need to be sent to the following address, which we will
            provide upon approval of your return request.
          </p>
          ...
          <p>
            To be eligible for a refund due to damage or defect, you must provide us with a video
            proof of the unopened package and the damaged product, recorded on the day of receipt.
            Once we review and approve your claim, we will process your refund or arrange a
            replacement.
          </p>
          ...
          <p>
            ...
            your original payment method within 10 business days. Please remember it can take some
