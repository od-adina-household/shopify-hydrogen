...
export default function CatchAllPage() {
  return (
    <div className="w-full">
      ...
      <section className="w-full bg-accent px-6 md:px-8 lg:px-12 py-12 md:py-16">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-normal text-foreground leading-tight mb-6 md:mb-8">
            Popular Collections
          </h2>
