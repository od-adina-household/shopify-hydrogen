    ...
    <div className="bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 md:px-8 lg:px-12 py-16 md:py-24">
        ...
        <div className="space-y-6 md:space-y-8 font-sans text-sm md:text-base leading-relaxed text-foreground">
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 1 &mdash; Access and Account
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 4 &mdash; Prices and Billing
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 5 &mdash; Shipping and Delivery
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 6 &mdash; Intellectual Property
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 7 &mdash; Optional Tools
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 8 &mdash; Third-Party Links
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 9 &mdash; Relationship with Shopify
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 10 &mdash; Privacy Policy
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 12 &mdash; Errors, Inaccuracies and Omissions
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 13 &mdash; Prohibited Uses
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 16 &mdash; Disclaimer of Warranties
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 17 &mdash; Limitation of Liability
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 18 &mdash; Indemnification
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 20 &mdash; Waiver; Entire Agreement
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 22 &mdash; Governing Law
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 24 &mdash; Changes to Terms of Service
          </h2>
          ...
          <h2 className="text-xl md:text-2xl font-serif leading-snug text-foreground pt-4">
            Section 25 &mdash; Contact Information
          </h2>
          ...
          <div className="space-y-1 text-muted-foreground">
            ...
            <p>
              <a
                href="mailto:adinaadnan12@gmail.com"
                className="text-muted-foreground underline underline-offset-4 hover:no-underline transition-all"
              >
                adinaadnan12@gmail.com
              </a>
            </p>
            <p>Al-Raheem Tower, Karachi, 7400, PK</p>
          </div>
        </div>
      </div>
    </div>
