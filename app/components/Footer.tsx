  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg aria-hidden="true" x="24" y="35" width="52" height="30" viewBox="0 0 687.1 430">
        ...
        <text
          ...
          opacity="0.75"
        >
          <textPath href="#badge-circle-path">✦ ADINA HOUSEHOLD ✦ ADINA HOUSEHOLD ✦</textPath>
        </text>
      </svg>
    </div>
  )
...
function InstagramIcon() {
  return (
    ...
    >
      <path
        d="M23.4871 28H5.51294C3.02916 28 1 25.9708 1 23.4871V5.51294C1 3.02916 3.02916 1 5.51294 1H23.4871C25.9708 1 28 3.02916 28 5.51294V23.4871C28 25.9819 25.9819 28 23.4871 28Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M9.60453 19.4066C10.913 20.715 12.6538 21.4357 14.5056 21.4357C16.3573 21.4357 18.0871 20.715 19.4066 19.4066C20.715 18.0982 21.4357 16.3573 21.4357 14.5056C21.4357 12.6538 20.715 10.9129 19.4066 9.60453C18.0982 8.29611 16.3573 7.57537 14.5056 7.57537C12.6538 7.57537 10.913 8.29611 9.60453 9.60453C8.29612 10.9129 7.57538 12.6538 7.57538 14.5056C7.57538 16.3573 8.29612 18.0982 9.60453 19.4066Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M22.7866 7.34763C23.5214 7.34763 24.1172 6.75188 24.1172 6.017C24.1172 5.28211 23.5214 4.68637 22.7866 4.68637C22.0517 4.68637 21.4559 5.28211 21.4559 6.017C21.4559 6.75188 22.0517 7.34763 22.7866 7.34763Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
function FacebookIcon() {
  return (
    ...
    >
      <path
        d="M27 14.5C27 21.4 21.4 27 14.5 27C7.6 27 2 21.4 2 14.5C2 7.6 7.6 2 14.5 2C21.4 2 27 7.6 27 14.5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M17.5 8H15.5C14.1 8 13 9.1 13 10.5V13H10.5V16H13V22H16V16H18.5L19 13H16V10.5C16 10.2 16.2 10 16.5 10H19V8H17.5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
        ...
        <div className="border-t-2 border-foreground">
          <div className="grid lg:grid-cols-[1fr_280px] gap-10 lg:gap-24 p-5 lg:px-12 py-8 lg:py-10">
            ...
            <div className="flex flex-col lg:items-end gap-5 lg:mt-2">
              <p
                className="text-lg font-medium lg:text-right"
